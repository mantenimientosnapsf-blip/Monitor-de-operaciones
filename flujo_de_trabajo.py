...
def mostrar_graficos():
    # Estilos CSS específicos para pantalla completa en gráficos
    st.markdown("""
        <style>
    ...
    # Botón para regresar al Monitor limpiando el estado
    ...
    def crear_anillo(df, titulo):
        try:
            ...
            fig.update_layout(
                ...
                showlegend=True,
                legend=dict(orientation="v", yanchor="middle", y=0.5, xanchor="left", x=1.05, font=dict(color='black', size=14)),
